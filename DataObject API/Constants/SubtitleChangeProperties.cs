...
public static class SubtitleChangeProperties {
    public const string ActFromCaption = "ActFromCaption";
    public const string ActFromCinema = "ActFromCinema";
    public const string ActFromLog = "ActFromLog";
    public const string CinemaStatusFromCaption = "CinemaStatusFromCaption";
    public const string CinemaStatusFromCinema = "CinemaStatusFromCinema";
    public const string CinemaStatusFromLog = "CinemaStatusFromLog";
    public const string LogFromCaption = "LogFromCaption";
